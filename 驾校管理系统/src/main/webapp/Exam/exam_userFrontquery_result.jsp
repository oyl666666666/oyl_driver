...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>考试id</td><td>考试名称</td><td>考试科目</td><td>考试日期</td><td>考试开始时间</td><td>考试地点</td><td>教练</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="examQueryForm" id="examQueryForm" action="<%=basePath %>Exam/userFrontlist" class="mar_t15" method="post">

        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- 
                 ...
                 <li><a href="<%=basePath %>YuyueType/frontlist">缴费类型</a></li> -->
                <li><a href="<%=basePath %>Jiaofei/frontlist">缴费记录</a></li>
                <li><a href="<%=basePath %>YuyueType/frontlist">约车详情</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>YuyueType/userFrontlist02"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;&nbsp;我要预约</a></li>

...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>缴费id</td><td>缴费类型</td><td>缴费名称</td><td>缴费金额</td><td>缴费时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="jiaofeiQueryForm" id="jiaofeiQueryForm" action="<%=basePath %>Jiaofei/userFrontlist" class="mar_t15" method="post">

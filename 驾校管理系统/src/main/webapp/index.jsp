...
<%--      <div class="item active" data-image-lg="<%=basePath %>images/slider/slide_01_2000x410.jpg" data-image-xs="<%=basePath %>images/slider/slide_01_640x340.jpg"></div>
      ...
      <div class="item" data-image-lg="<%=basePath %>images/slider/slide_04_2000x410.jpg" data-image-xs="<%=basePath %>images/slider/slide_04_640x340.jpg"></div>--%>
        <div class="item active" data-image-lg="<%=basePath %>images/slider/001.jpg" data-image-xs="<%=basePath %>images/slider/001.jpg"></div>
<%--        <div class="item" data-image-lg="<%=basePath %>images/slider/001.jpg" data-image-xs="<%=basePath %>images/slider/001.jpg"></div>--%>
        <div class="item" data-image-lg="<%=basePath %>images/slider/002.jpg" data-image-xs="<%=basePath %>images/slider/002.jpg"></div>
        <div class="item" data-image-lg="<%=basePath %>images/slider/003.jpg" data-image-xs="<%=basePath %>images/slider/003.jpg"></div>
    </div> 
    <!-- 控制按钮 -->
...
<%--                <i class="icon-uniE907"></i>--%>
              ...
              <div class="media-body">
                <h4 class="media-heading"><a href="https://ha.122.gov.cn/" target="_blank">交通安全综合服务管理平台</a></h4>
<%--                <p>此设计已经通过了精心调试</p>--%>
                <img src="images/12123.PNG">
              </div>
            </div>
          </a>
        </div>
...
<%--                <i class="icon-uniE907"></i>--%>
              ...
              <div class="media-body">
                <h4 class="media-heading"><a href="https://www.jiakaobaodian.com/" target="_blank">驾考宝典</a></h4>
<%--                <p>此设计已经通过了精心调试</p>--%>
                <img src="images/jiakao.PNG">
              </div>
            </div>
          </a>
        </div>
